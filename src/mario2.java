 ...
 * @author ekjot
 */
public class mario2 extends javax.swing.JFrame {

    /**
     * Creates new form mario2
     */
    public mario2() {
        initComponents();
    }
   ...
   int old_pole_dist=6,man_y_pos=8,man_x_pos=2,jump=0,score=0,diagonal_direction=0,jump_delay=0;
boolean diagonal_jump=false;
   
   
     JLabel  ekjot =new javax.swing.JLabel();
    ...
    ActionListener screenListener=new ActionListener()
    {
      ...
      /*
     ekjot.setFont(new java.awt.Font("Comic Sans MS", 0, 13));
     ekjot.setText("X");
      ...
      javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        ...
        layout.setHorizontalGroup(
         layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING) .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                       .addGap(100+3*man_x_pos).addComponent(ekjot)
         ...
         layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING) .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(285+10*man_y_pos).addComponent(ekjot)
    ...
    ActionListener manListener=new ActionListener()
    {
      ...
      ActionListener diagonalJumpListener=new ActionListener()
      {
    ...
    Timer screen=new Timer(5,screenListener);
     Timer pole_bait=new Timer(1,pole_baitListener);
      ...
      Timer d_j=new Timer(200,diagonalJumpListener);
    ...
    void update_man(int direction)
    {
        ...
        if(jump==1)
        {
            man_y_pos--;
        if(diagonal_jump){ 
        if(man_x_pos>0&&man_x_pos<59){man_x_pos=man_x_pos+diagonal_direction;} 
       ...
       if(man_x_pos>0&&man_x_pos<59){man_x_pos=man_x_pos+diagonal_direction;} }
        ...
        else if(man_y_pos==8)
        {
            ...
            if(jump_delay==1){diagonal_jump=false;diagonal_direction=0;jump_delay=0; }
    ...
    private void formKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_formKeyPressed
        ...
        if(evt.getKeyChar()==' '||evt.getKeyCode()==KeyEvent.VK_UP)
        {

                jump++;
  if(d_j.isRunning()){diagonal_jump=true; }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mario2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
